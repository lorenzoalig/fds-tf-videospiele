...
@Service
public class CalculaValorContratoService {
    IContratoRepository contratoRepository;

    public CalculaValorContratoService(IContratoRepository contratoRepository) {
        this.contratoRepository = contratoRepository;
    }

    public double calculaValorById(int id) {
